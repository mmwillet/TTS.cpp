...
struct dia_model : tts_model, dia_model_constants {
    ...
    explicit dia_model(const shared_ptr<gpu_context> & gpu, gguf_context * meta, ggml_context * weights)
        : tts_model{gpu, model_tensor_meta{weights, "dia", 130}}, dia_model_constants{meta}, encoder{n_encoder_layers}, decoder{n_decoder_layers, n_output_heads} {
    }
};
