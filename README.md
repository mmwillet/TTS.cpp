...
* Local GGUF format model file (see [py-gguf-parler-tts](./py-gguf-parler-tts/README.md) and [py-gguf-kokoro](./py-gguf-kokoro/README.md) for information on how to convert the hugging face models to GGUF).
* C++17 and C17
